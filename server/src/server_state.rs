...
impl ServerState {
    pub fn new() -> Self {
        let (kanjidic, kanjidic_time) = measure_time(|| Kanjidic::parse("../res/kanjidic2_no_doctype.xml"));
        ...
        let (dict, dict_time) = measure_time(|| JMdict::parse("../res/JMdict_e_no_doctype.xml"));
